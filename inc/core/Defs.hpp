...
// This epsilon should match the one used by ivr for consistency.
...
// ERR/WARN macros
#ifndef WARN_PRINT
#define WARN_PRINT(msg) ivr::IVR::print_warning(msg, __func__, __FILE__, __LINE__)
#endif
...
#ifndef ERR_PRINT
#define ERR_PRINT(msg) ivr::IVR::print_error(msg, __func__, __FILE__, __LINE__)
#endif
...
#ifndef FATAL_PRINT
#define FATAL_PRINT(msg) ERR_PRINT(ivr::String("FATAL: ") + (msg))
#endif

#ifndef ERR_MSG_INDEX
#define ERR_MSG_INDEX(index, size) (ivr::String("Index ") + #index + "=" + ivr::String::num_int64(index) + " out of size (" + #size + "=" + ivr::String::num_int64(size) + ")")
#endif

#ifndef ERR_MSG_NULL
#define ERR_MSG_NULL(param) (ivr::String("Parameter '") + #param + "' is null.")
#endif

#ifndef ERR_MSG_COND
#define ERR_MSG_COND(cond) (ivr::String("Condition '") + #cond + "' is true.")
#endif
