...
class String {
	ivr_string _ivr_string;

	friend class Dictionary;
	friend class NodePath;
	friend class Variant;
	explicit inline String(ivr_string contents) :
			_ivr_string(contents) {}
...
public:
	...
	static String chr(ivr_char_type p_char);
