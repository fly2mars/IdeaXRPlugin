...
// Functions reproduced as in ivr's source code `math_funcs.h`.
// Some are overloads to automatically support changing real_t into either double or float in the way ivr does.
