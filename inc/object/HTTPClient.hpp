#ifndef IVR_CPP_HTTPCLIENT_HPP
#define IVR_CPP_HTTPCLIENT_HPP
...
class HTTPClient : public Reference {
	struct ___method_bindings {
		...
		ivr_method_bind *mb_get_connection;
		ivr_method_bind *mb_get_read_chunk_size;
		ivr_method_bind *mb_get_response_body_length;
		ivr_method_bind *mb_get_response_code;
		ivr_method_bind *mb_get_response_headers;
		ivr_method_bind *mb_get_response_headers_as_dictionary;
		ivr_method_bind *mb_get_status;
		ivr_method_bind *mb_has_response;
		ivr_method_bind *mb_is_blocking_mode_enabled;
		ivr_method_bind *mb_is_response_chunked;
		ivr_method_bind *mb_poll;
		ivr_method_bind *mb_query_string_from_dict;
		ivr_method_bind *mb_read_response_body_chunk;
		ivr_method_bind *mb_request;
		ivr_method_bind *mb_request_raw;
		ivr_method_bind *mb_set_blocking_mode;
		ivr_method_bind *mb_set_connection;
		ivr_method_bind *mb_set_read_chunk_size;
	};
...
public:
	...
	static inline const char *___get_ivr_class_name() { return (const char *) "HTTPClient"; }
