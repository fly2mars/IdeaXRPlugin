#ifndef IVR_CPP_STREAMPEERTCP_HPP
#define IVR_CPP_STREAMPEERTCP_HPP
...
class StreamPeerTCP : public StreamPeer {
	struct ___method_bindings {
		...
		ivr_method_bind *mb_disconnect_from_host;
		ivr_method_bind *mb_get_connected_host;
		ivr_method_bind *mb_get_connected_port;
		ivr_method_bind *mb_get_status;
		ivr_method_bind *mb_is_connected_to_host;
		ivr_method_bind *mb_set_no_delay;
	};
...
public:
	...
	static inline const char *___get_ivr_class_name() { return (const char *) "StreamPeerTCP"; }
