#ifndef IVR_CPP_MULTIMESH_HPP
#define IVR_CPP_MULTIMESH_HPP
...
class MultiMesh : public Resource {
	struct ___method_bindings {
		ivr_method_bind *mb__get_color_array;
		ivr_method_bind *mb__get_custom_data_array;
		ivr_method_bind *mb__get_transform_2d_array;
		ivr_method_bind *mb__get_transform_array;
		ivr_method_bind *mb__set_color_array;
		ivr_method_bind *mb__set_custom_data_array;
		ivr_method_bind *mb__set_transform_2d_array;
		ivr_method_bind *mb__set_transform_array;
		ivr_method_bind *mb_get_aabb;
		ivr_method_bind *mb_get_color_format;
		ivr_method_bind *mb_get_custom_data_format;
		ivr_method_bind *mb_get_instance_color;
		ivr_method_bind *mb_get_instance_count;
		ivr_method_bind *mb_get_instance_custom_data;
		ivr_method_bind *mb_get_instance_transform;
		ivr_method_bind *mb_get_instance_transform_2d;
		ivr_method_bind *mb_get_mesh;
		ivr_method_bind *mb_get_transform_format;
		ivr_method_bind *mb_get_visible_instance_count;
		ivr_method_bind *mb_set_as_bulk_array;
		ivr_method_bind *mb_set_color_format;
		ivr_method_bind *mb_set_custom_data_format;
		ivr_method_bind *mb_set_instance_color;
		ivr_method_bind *mb_set_instance_count;
		ivr_method_bind *mb_set_instance_custom_data;
		ivr_method_bind *mb_set_instance_transform;
		ivr_method_bind *mb_set_instance_transform_2d;
		ivr_method_bind *mb_set_mesh;
		ivr_method_bind *mb_set_transform_format;
		ivr_method_bind *mb_set_visible_instance_count;
	};
...
public:
	...
	static inline const char *___get_ivr_class_name() { return (const char *) "MultiMesh"; }
