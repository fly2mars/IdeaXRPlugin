#ifndef IVR_CPP_PHYSICS2DSHAPEQUERYPARAMETERS_HPP
#define IVR_CPP_PHYSICS2DSHAPEQUERYPARAMETERS_HPP
...
class Physics2DShapeQueryParameters : public Reference {
	struct ___method_bindings {
		ivr_method_bind *mb_get_collision_layer;
		ivr_method_bind *mb_get_exclude;
		ivr_method_bind *mb_get_margin;
		ivr_method_bind *mb_get_motion;
		...
		ivr_method_bind *mb_set_collision_layer;
		ivr_method_bind *mb_set_exclude;
		ivr_method_bind *mb_set_margin;
		ivr_method_bind *mb_set_motion;
...
public:
	...
	static inline const char *___get_ivr_class_name() { return (const char *) "Physics2DShapeQueryParameters"; }
