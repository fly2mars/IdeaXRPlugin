#ifndef IVR_CPP_MESH_HPP
#define IVR_CPP_MESH_HPP
...
class Mesh : public Resource {
	struct ___method_bindings {
		ivr_method_bind *mb_create_convex_shape;
		ivr_method_bind *mb_create_outline;
		ivr_method_bind *mb_create_trimesh_shape;
		ivr_method_bind *mb_generate_triangle_mesh;
		ivr_method_bind *mb_get_aabb;
		ivr_method_bind *mb_get_faces;
		ivr_method_bind *mb_get_lightmap_size_hint;
		ivr_method_bind *mb_get_surface_count;
		ivr_method_bind *mb_set_lightmap_size_hint;
		ivr_method_bind *mb_surface_get_arrays;
		ivr_method_bind *mb_surface_get_blend_shape_arrays;
		ivr_method_bind *mb_surface_get_material;
		ivr_method_bind *mb_surface_set_material;
	};
...
public:
	...
	static inline const char *___get_ivr_class_name() { return (const char *) "Mesh"; }
	...
	Mesh *create_outline(const real_t margin) const;
